    ...
    <div>
      ...
      <div className="relative">
        <input type={type} value={value} onChange={onChange} placeholder={placeholder}
          className={`w-full px-3.5 py-2.5 rounded-xl text-sm text-gray-900 placeholder-gray-400 border transition-all ${error
            ? "border-red-500/40 bg-red-50"
            : "border-white/20 bg-white focus:border-ember-500/50"
          }`}
          style={{ outline: "none" }} />
        {suffix}
      </div>
